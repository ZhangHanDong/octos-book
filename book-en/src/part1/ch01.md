...
- **octos-pipeline** (9,137 lines): Workflow engine. Defines workflow topology using Graphviz DOT syntax, supporting 5 Handler types, parallel fan-out, conditional branching, Human Gate, and checkpoint resume. Depends on octos-core, octos-agent, octos-llm, and octos-memory.
