...
- 源码文件: `../octos/crates/octos-agent/src/agent/loop_compaction.rs`, `../octos/crates/octos-agent/src/compaction_tiered.rs`, `../octos/crates/octos-agent/src/summarizer.rs`, `../octos/crates/octos-agent/src/workspace_contract.rs`, `../octos/crates/octos-agent/src/workspace_git.rs`, `../octos/crates/octos-agent/src/validators.rs`, `../octos/crates/octos-agent/src/prompt_guard.rs`
...
场景: contract-gated tiered compaction
  ...
  那么 解释 tiered compactor 如何保留最近消息、折叠历史和保留 contract-critical artifacts
